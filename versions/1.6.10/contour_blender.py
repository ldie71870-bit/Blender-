...
def _generate(scene, settings, progress=None):
    ...
    report = dict(version='1.6.10',region=region.name if region else None,method='LAYERED_CONTOUR',columns=columns,support_samples=len(supports),
