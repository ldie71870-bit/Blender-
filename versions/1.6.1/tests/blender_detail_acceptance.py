...
assert all(route.detail_gain>0 and valid(*route.points) for _,_,route in routes)
assert all(.59<=addon.contour_blender.planner.length(route.points)<=1.21 for _,_,route in routes)
