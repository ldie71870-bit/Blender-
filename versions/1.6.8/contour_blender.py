...
class SceneProbe:
    ...
    def build_geometry(self):
        ...
        for instance in self.depsgraph.object_instances:
            obj=instance.object
            if obj.type!='MESH' or obj.get('gs_camera_mesh_visual') or obj.get('gs_contour_version') or obj.original.get('gs_contour_version'):continue
...
def _generate(scene, settings, progress=None):
    ...
    report = dict(version='1.6.8',method='LAYERED_CONTOUR',columns=columns,support_samples=len(supports),
