...
settings.interface_mode='PRO'
settings.live_update_cameras=False
assert not settings.contour_region_enabled
assert addon._addon_version_str()=='1.6.11'
metadata=addon.bl_info
addon.bl_info={}
assert addon._addon_version_str()=='1.6.11', 'Extension metadata must not reset the UI to 1.3.4'
