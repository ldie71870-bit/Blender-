...
def planning_settings_signature(settings):
    keys = (
        ...
        "multilevel_planning", "curve_smoothing", "fragment_stitching",
        "multilevel_floor_tolerance", "multilevel_maximum_step", "multilevel_maximum_slope",
        "multilevel_minimum_floor_cells", "fragment_stitch_distance", "fragment_stitch_angle",
        "curve_smoothing_iterations", "multilevel_large_room_area", "multilevel_coverage_paths",
